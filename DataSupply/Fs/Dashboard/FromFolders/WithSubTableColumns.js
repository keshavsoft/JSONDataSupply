...
let CommonNewItems = require("../../Config/Folders/Files/Items/PullData/WithSubTableColumns");
...
class FuncsWithColumns {
    ...
    static PullFiles2 = ({ inFolderName, inFilesArray, inUserPK }) => {
        let LocalFileObject;
    ...
    static PullFiles1 = ({ inFolderName, inFilesArray, inUserPK }) => {
        let LocalFileObject;
