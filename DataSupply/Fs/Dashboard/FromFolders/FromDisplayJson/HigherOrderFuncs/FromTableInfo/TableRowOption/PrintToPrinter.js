            ...
            ([key, value]) => {
                ...
                if ("TableInfo" in value) {
                    if ("TableRowOptions" in value.TableInfo) {
                        if ("PrintToPrinter" in value.TableInfo.TableRowOptions) {
                            LocalLoopObject.Double = value.TableInfo.TableRowOptions.PrintToPrinter.Double;
                            LocalLoopObject.Barcode = value.TableInfo.TableRowOptions.PrintToPrinter.Barcode;
