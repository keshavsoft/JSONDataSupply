        ...
        Object.entries(inData).forEach(
            ([key, value]) => {
                ...
                if ("TableInfo" in value) {
                    if ("Vertical" in value.TableInfo) {
                        if ("VerticalCreate" in value.TableInfo.Vertical) {
                            LocalLoopObject.saveFromKeyAsTree = value.TableInfo.Vertical.VerticalCreate.saveFromKeyAsTree;
                        }
                    }
