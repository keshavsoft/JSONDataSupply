...
let CommonFromDisplayJson = require("../../../PullData/FromDisplayJson/FromJson");
...
let LocalPrepareHTMLObject = {
    Vertical: async ({ inJsonConfig, inItemConfig, inPK, inDataPK }) => {
        ...
        let LocalDisplayForFileJsonData = await CommonFromDisplayJson.AsJsonAsync({
            inJsonConfig,
            inItemConfig,
            inDataPK
        });

        let LocalTableInfo = LocalDisplayForFileJsonData["TableInfo"];
        LocalHtmlVerticalObject.KData.TableColumns = LocalDisplayForFileJsonData["TableColumns"];
    ...
    SubTables: {
        StartFunc: async ({ inJsonConfig, inItemConfig, inPK, inDataPK }) => {
            ...
            let LocalSubTableColumns = LocalDisplayForFileJsonData["SubTableColumns"];
