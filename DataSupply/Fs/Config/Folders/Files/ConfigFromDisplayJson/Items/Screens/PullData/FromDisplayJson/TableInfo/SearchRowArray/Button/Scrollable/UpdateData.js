...
let LocalUpdateFunc = ({ inItemName, inScreenName, inOriginalData, inDataToUpdate }) => {
    ...
    let LocalCommonKey = `${LocalItemName}.${LocalScreenName}.TableInfo.SearchRowArray.Button.Scrollable`;
    console.log("ppppppppppppp:",LocalCommonKey);
