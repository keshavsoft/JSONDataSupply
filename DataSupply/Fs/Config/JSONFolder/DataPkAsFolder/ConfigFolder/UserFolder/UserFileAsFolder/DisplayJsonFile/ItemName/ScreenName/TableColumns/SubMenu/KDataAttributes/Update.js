    ...
    if (LocalItemName in LocalNewData) {
        if (LocalScreenName in LocalNewData[LocalItemName]) {
            if (LocalJsonTableColumnsKey in LocalNewData[LocalItemName][LocalScreenName]) {
                ...
                LocalFindColumnObject.KDataAttributes.onkeypress = LocalDataToUpdate.onkeypress;
                LocalFindColumnObject.KDataAttributes.EnterOnClient = LocalDataToUpdate.EnterOnClient;
                LocalFindColumnObject.KDataAttributes.ClientEval = LocalDataToUpdate.ClientEval;
                LocalFindColumnObject.KDataAttributes.CustomDataList = LocalDataToUpdate.CustomDataList;
