    ...
    if (LocalItemName in LocalNewData) {
        if (LocalScreenName in LocalNewData[LocalItemName]) {
            if ("TableInfo" in LocalNewData[LocalItemName][LocalScreenName]) {
                LocalNewData[LocalItemName][LocalScreenName].TableInfo.SearchRowArray.Search.KTF = LocalDataToUpdate.KTF;
                LocalNewData[LocalItemName][LocalScreenName].TableInfo.SearchRowArray.Search.DisplayObject.DisplayText = LocalDataToUpdate.DisplayText;
                LocalNewData[LocalItemName][LocalScreenName].TableInfo.SearchRowArray.Search.DisplayObject.ColClass = LocalDataToUpdate.ColClass;
