...
let Update = async ({ DataPK, FolderName, FileName, ItemName, ScreenName, GridName, BodyAsJson }) => {
    const LocalDataToUpdate = (({ SubTableRowEdit }) => ({ SubTableRowEdit }))(BodyAsJson);
    ...
    LocalNewData[LocalItemName][LocalScreenName].SubTableColumns[localGridName].TableInfo.TableRowOptions.Edit.SubTableRowEdit = LocalDataToUpdate.SubTableRowEdit;
