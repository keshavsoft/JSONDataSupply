                                ...
                                Object.entries(ScreenValue.TableColumnsObject).forEach(
                                    ([ColumnKey, ColumnValue]) => {
                                        LoopInsideFile.Files[FileKey].Items[ItemKey].Screens[ScreenKey].TableColumnsObject[ColumnKey] = {
                                            ...
                                            PickFrom: ColumnValue.ServerSide.EnterToServer.PickFrom,
                                            FolderName: ColumnValue.ServerSide.EnterToServer.FolderName,
                                            FileName: ColumnValue.ServerSide.EnterToServer.FileName,
                                            ItemName: ColumnValue.ServerSide.EnterToServer.ItemName,
                                            ColumnName: ColumnValue.ServerSide.EnterToServer.ColumnName,
                                            Active: ColumnValue.ServerSide.EnterToServer.Active
                                        };
                                    }
                                );
                            }
