                                ...
                                Object.entries(ScreenValue.TableColumnsObject).forEach(
                                    ([ColumnKey, ColumnValue]) => {
                                        LoopInsideFile.Files[FileKey].Items[ItemKey].Screens[ScreenKey].TableColumnsObject[ColumnKey] = {
                                            ...
                                            ControlType: ColumnValue.ServerSide.DefaultValueShow.ControlType,
                                            Format: ColumnValue.ServerSide.DefaultValueShow.Format,
                                            Type:ColumnValue.ServerSide.DefaultValueShow.Type,
                                            Transform:ColumnValue.ServerSide.DefaultValueShow.Transform
                                        };
                                    }
                                );
                            }
