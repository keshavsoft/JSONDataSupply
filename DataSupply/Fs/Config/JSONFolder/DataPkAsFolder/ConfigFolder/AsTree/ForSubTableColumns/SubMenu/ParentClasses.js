                                                ...
                                                Object.entries(SubColumnValue.TableColumnsObject).forEach(
                                                    ([SubColumnTableColumnKey, SubColumnTableColumnValue]) => {
                                                        LoopInsideFile.Files[FileKey].Items[ItemKey].Screens[ScreenKey].SubTableColumnsObject[SubColumnKey].TableColumnsObject[SubColumnTableColumnKey] = {
                                                            ...
                                                            Parent1Class: SubColumnTableColumnValue.ParentClasses.Parent1Class,
                                                            Parent2Class: SubColumnTableColumnValue.ParentClasses.Parent2Class,
                                                            Parent3Class: SubColumnTableColumnValue.ParentClasses.Parent3Class,
                                                            InputClass: SubColumnTableColumnValue.ParentClasses.InputClass
                                                        };
